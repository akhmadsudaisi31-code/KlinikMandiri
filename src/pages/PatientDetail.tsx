...
import { 
  doc, getDoc, collection, addDoc, query, where, orderBy, onSnapshot 
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start pb-20">
      ...
      <div className="lg:col-span-1 space-y-6 lg:sticky lg:top-24">
        ...
        <button onClick={() => navigate('/')} className="w-full py-3 text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-dark-surface hover:bg-gray-50 dark:hover:bg-gray-800 transition-all shadow-sm hover:shadow-md">
